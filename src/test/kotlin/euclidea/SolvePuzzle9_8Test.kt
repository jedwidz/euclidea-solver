...
class SolvePuzzle9_8Test {
    // Harmonic Mean of Segments
    ...
    class Solver : ImprovingSolver<Params, Setup>() {
        ...
        override fun initialContext(
            ...
            with(params) {
                val context = object {
                    // Should be a line segment - might need parameters adjusted
                    //                    val line1 = Element.Line(baseO, baseA, limit1 = true, limit2 = true)
                    val line1 = Element.Line(baseO, baseA)
                    val line2 = Element.Line(baseO, dir, limit1 = true)
                }
